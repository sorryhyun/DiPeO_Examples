...
function getBreakpoints(): ResponsiveConfig {
  try {
    // Try to get breakpoints from theme tokens and map to our responsive names
    if (tokens?.breakpoints) {
      return {
        mobile: parseInt(tokens.breakpoints.sm) || defaultBreakpoints.mobile,
        tablet: parseInt(tokens.breakpoints.md) || defaultBreakpoints.tablet,
        desktop: parseInt(tokens.breakpoints.lg) || defaultBreakpoints.desktop,
        wide: parseInt(tokens.breakpoints.xl) || defaultBreakpoints.wide,
      };
    }
  } catch {
