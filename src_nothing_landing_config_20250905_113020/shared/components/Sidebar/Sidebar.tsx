...
const NavItem: React.FC<{
  ...
  return (
    <motion.div
      ...
      whileHover={!item.disabled ? { backgroundColor: theme.colors.gray[100] } : {}}
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  }, [autoCollapseOnMobile, isMobile, onCollapse, collapsed, internalCollapsed]);
  ...
  const handleNavigate = useCallback((item: NavigationItem) => {
    ...
    if (autoCollapseOnMobile && isMobile && !effectiveCollapsed) {
      handleToggle();
    }
  }, [onNavigate, activeItemId, autoCollapseOnMobile, isMobile, effectiveCollapsed, handleToggle]);
