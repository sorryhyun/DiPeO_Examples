...
Self-Check Comments:
- [x] Uses `@/` imports only
- [x] Uses providers/hooks (no direct DOM/localStorage side effects) - Pure utility functions
- [x] Reads config from `@/app/config`
- [x] Exports default named component - Not applicable, exports utility functions
- [x] Adds basic ARIA and keyboard handlers (where relevant) - Provides ARIA and keyboard utilities
*/
